    ...
    inner class AppViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(app: AppInfo) {
            ...
            val icon = if (preferences.iconPack.isNotEmpty()) {
                com.cykrome.launcher.util.AppLoader.getIconPackIcon(context, preferences.iconPack, app) ?: app.icon
            } else {
                app.icon
            }
                    ...
                    android.view.MotionEvent.ACTION_MOVE -> {
                        if (hasShownMenu || isLongPressed) {
                            ...
                            if (distance > dragThreshold) {
                                ...
                                hasShownMenu = false
                                // Close menu
                                this@AlphaVerticalRecyclerAdapter.closeMenu()
        ...
        private fun showAppMenu(app: AppInfo) {
            ...
            if (isOnRightSide) {
                ...
                try {
                    ...
                    android.util.Log.d("AlphaVerticalRecyclerAdapter", "Could not set menu offset: ${e.message}")
                }
            } else {
            ...
            this@AlphaVerticalRecyclerAdapter.currentPopupMenu = popupMenu
            ...
            try {
                ...
                android.util.Log.d("AlphaVerticalRecyclerAdapter", "Could not prevent auto-dismiss: ${e.message}")
            }
            ...
            popupMenu.setOnDismissListener {
                this@AlphaVerticalRecyclerAdapter.currentPopupMenu = null
        ...
        private fun uninstallApp(app: AppInfo) {
            try {
                ...
                android.util.Log.e("AlphaVerticalRecyclerAdapter", "Error uninstalling app: ${e.message}", e)
            }
        }
        ...
        private fun showAppInfo(app: AppInfo) {
            try {
                ...
                android.util.Log.e("AlphaVerticalRecyclerAdapter", "Error showing app info: ${e.message}", e)
            }
        }
    ...
    inner class AppViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
                    ...
                    android.view.MotionEvent.ACTION_MOVE -> {
                        if (hasShownMenu || isLongPressed) {
                            ...
                            if (distance > dragThreshold) {
                                ...
                                hasShownMenu = false
                                // Close menu
                                this@AlphaListRecyclerAdapter.closeMenu()
                                // Notify parent to start drag (this will close drawer)
                                onAppLongClick?.invoke(app)
                                // Start drag
                                val dragShadowBuilder = android.view.View.DragShadowBuilder(v)
        ...
        private fun showAppMenu(app: AppInfo) {
            ...
            if (isOnRightSide) {
                ...
                try {
                    ...
                    // Reflection failed, try alternative approach - use gravity only
                    android.util.Log.d("AlphaListRecyclerAdapter", "Could not set menu offset: ${e.message}")
                }
            } else {
                // Default: show menu on the right side of the anchor
                popupMenu.gravity = android.view.Gravity.END
            ...
            // Store reference to close it later
            this@AlphaListRecyclerAdapter.currentPopupMenu = popupMenu
            ...
            try {
                ...
                // Fallback if reflection fails
                android.util.Log.d("AlphaListRecyclerAdapter", "Could not prevent auto-dismiss: ${e.message}")
            }
            ...
            popupMenu.setOnDismissListener {
                this@AlphaListRecyclerAdapter.currentPopupMenu = null
                // Hide blur overlay when menu is dismissed
                (context as? android.app.Activity)?.let { activity ->
                    if (activity is com.cykrome.launcher.ui.LauncherActivity) {
                        activity.hideBlurOverlay()
        ...
        private fun uninstallApp(app: AppInfo) {
            try {
                ...
                android.util.Log.e("AlphaListRecyclerAdapter", "Error uninstalling app: ${e.message}", e)
            }
        }
        ...
        private fun showAppInfo(app: AppInfo) {
            try {
                ...
                android.util.Log.e("AlphaListRecyclerAdapter", "Error showing app info: ${e.message}", e)
            }
        }
